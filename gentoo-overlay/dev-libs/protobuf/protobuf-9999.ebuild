...
inherit autotools eutils distutils-r1 git-2 java-pkg-opt-2 elisp-common

DESCRIPTION="Google's Protocol Buffers -- an efficient method of encoding structured data"
HOMEPAGE="http://code.google.com/p/protobuf/"
#SRC_URI="http://protobuf.googlecode.com/files/${P}.tar.bz2"
EGIT_REPO_URI="https://github.com/openx/python3-protobuf.git"
EGIT_BRANCH="master"
...
src_prepare() {
	...
	epatch "${FILESDIR}"/${PN}-9999-typo.patch
	eautoreconf
